...
Pro deepens what is already here — advanced CRM, the purchase side of the
books, banking, tax and budgets. The optional modules are whole applications
that install beside it: **Booking**, **Shop**, **Projects** and **Documents**.
...
- **Invoicing** — quotes and invoices with per-line tax, partial payments,
  sequential numbering, quote-to-invoice conversion, a discount for paying
  early, merging several drafts into one invoice, and CSV export
- **Accounting** — chart of accounts, money in and out, and a real double-entry
  ledger with profit & loss and a balance sheet for any period
...
Optional modules are bought individually on top of Pro — **Booking**, **Shop**
and **Documents**. A module needs Pro underneath it; it is not sold against the
Free tier.
...
install path works end to end on both Docker and Podman. It has not yet been
